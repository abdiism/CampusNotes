      ...
      <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:py-16 lg:px-8">
        <div className="xl:grid xl:grid-cols-3 xl:gap-8">
          ...
          <div className="space-y-4 xl:col-span-1">
            <img className="h-10" src="/logo.png" alt="FindMyNotes Logo - Footer" /> {/* Adjust path/style */}
                 ...
                 <div>
                    <h3 className="text-sm font-semibold uppercase tracking-wider text-gray-400">Contact</h3>
                     <ul role="list" className="mt-4 space-y-2">
                        ...
                        <li><a href="mailto:findmynotes2022@gmail.com" className="text-base text-gray-300 hover:text-white">findmynotes2022@gmail.com</a></li>
        ...
        <div className="mt-12 border-t border-gray-700 pt-8">
          <p className="text-base text-gray-400 xl:text-center">
            &copy; {currentYear} FindMyNotes. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
